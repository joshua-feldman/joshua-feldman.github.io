...
For newcomers to the band - and seasoned listeners alike - such diversity can be overwhelming. It might even appear that The Beatles' music is uncategorisable - a series of discrete ventures into different genres and subgenres. However, with the power of **k-means clustering**, we can segment Beatles tracks according to nine acoustic features that are used by Spotify and academic researchers to classify music, namely:
...
### Cluster #1: Meditations

Several of the tracks in this cluster were penned by George Harrison. They are often sad and meditative, emphasising sensitivity and reflectiveness over pace.

* __Key features__: Low valence
* __Number of songs__: 26 (14% of total)
* __Famous examples__: Here Comes The Sun; Let It Be; Come Together
...
With high liveness, Cluster #2 tracks give the impression that they were recorded in front of a live audience. They are loud, energetic and written with the stage in mind.

* __Key features__: High liveness
* __Number of songs__: 13 (7% of total)
* __Famous examples__: I Am The Walrus; Get Back; She Said She Said
...
* __Famous examples__: Sun King; Mother Nature's Son; Flying
...
Cluster #4 is skewed towards The Beatles' earlier work but also the second most populous cluster after Cluster #6. Its songs have an acoustic rather than electric bent.

* __Key features__: High acousticness, high danceability
* __Number of songs__: 35 (19% of total)
* __Famous examples__: In My Life; Eleanor Rigby; And I Love Her
...
* __Famous examples__: Strawberry Fields Forever; I'm So Tired; Polythene Pam
...
* __Famous examples__: Help!; While My Guitar Gently Weeps; Penny Lane
...
* __Famous examples__: Twist And Shout; I Saw Her Standing There; A Hard Day's Night
...
* __Famous examples__: Yesterday; Blackbird; Golden Slumbers
